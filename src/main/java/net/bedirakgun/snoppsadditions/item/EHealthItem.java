...
public class EHealthItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_health")
	public static final Item block = null;

	public EHealthItem(SnoppsAdditionsModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(12).rarity(Rarity.RARE));
			setRegistryName("e_health");
		}
