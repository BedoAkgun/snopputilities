...
public class HealthMidItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:health_mid")
	public static final Item block = null;

	public HealthMidItem(SnoppsAdditionsModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(20).rarity(Rarity.UNCOMMON));
			setRegistryName("health_mid");
		}
