...
public class ESwiftnessMidItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_swiftness_mid")
	public static final Item block = null;

	public ESwiftnessMidItem(SnoppsAdditionsModElements instance) {
		super(instance, 29);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("e_swiftness_mid");
		}
