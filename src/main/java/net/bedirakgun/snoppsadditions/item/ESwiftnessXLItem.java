...
public class ESwiftnessXLItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_swiftness_xl")
	public static final Item block = null;

	public ESwiftnessXLItem(SnoppsAdditionsModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("e_swiftness_xl");
		}
