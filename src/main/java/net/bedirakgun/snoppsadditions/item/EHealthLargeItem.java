...
public class EHealthLargeItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_health_large")
	public static final Item block = null;

	public EHealthLargeItem(SnoppsAdditionsModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(50).rarity(Rarity.RARE));
			setRegistryName("e_health_large");
		}
