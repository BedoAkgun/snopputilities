...
public class EHasteItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_haste")
	public static final Item block = null;

	public EHasteItem(SnoppsAdditionsModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(10).rarity(Rarity.RARE));
