...
public class HasteItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:haste")
	public static final Item block = null;

	public HasteItem(SnoppsAdditionsModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(5).rarity(Rarity.UNCOMMON));
