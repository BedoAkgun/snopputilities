...
public class EPowerMidItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_power_mid")
	public static final Item block = null;

	public EPowerMidItem(SnoppsAdditionsModElements instance) {
		super(instance, 39);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(14).rarity(Rarity.RARE));
			setRegistryName("e_power_mid");
		}
