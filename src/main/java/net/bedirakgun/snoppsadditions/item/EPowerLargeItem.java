...
public class EPowerLargeItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_power_large")
	public static final Item block = null;

	public EPowerLargeItem(SnoppsAdditionsModElements instance) {
		super(instance, 40);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(25).rarity(Rarity.RARE));
			setRegistryName("e_power_large");
		}
