...
public class HealthItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:health")
	public static final Item block = null;

	public HealthItem(SnoppsAdditionsModElements instance) {
		super(instance, 12);
	}
