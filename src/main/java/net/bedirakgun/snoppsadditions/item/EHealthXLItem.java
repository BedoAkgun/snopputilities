...
public class EHealthXLItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_health_xl")
	public static final Item block = null;

	public EHealthXLItem(SnoppsAdditionsModElements instance) {
		super(instance, 20);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(150).rarity(Rarity.RARE));
			setRegistryName("e_health_xl");
		}
