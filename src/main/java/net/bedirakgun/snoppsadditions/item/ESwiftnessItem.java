...
public class ESwiftnessItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_swiftness")
	public static final Item block = null;

	public ESwiftnessItem(SnoppsAdditionsModElements instance) {
		super(instance, 28);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(6).rarity(Rarity.RARE));
			setRegistryName("e_swiftness");
		}
