...
public class EPowerItem extends SnoppsAdditionsModElements.ModElement {
	@ObjectHolder("snopps_additions:e_power")
	public static final Item block = null;

	public EPowerItem(SnoppsAdditionsModElements instance) {
		super(instance, 38);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SnoopsPotionsItemGroup.tab).maxDamage(8).rarity(Rarity.RARE));
			setRegistryName("e_power");
		}
